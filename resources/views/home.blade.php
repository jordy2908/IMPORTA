...
@endif
    <script>
        ...
        //         document.getElementById("calculadora").innerHTML += '<div class="c-cuerpo" style="display: flex; flex-direction: row; width: 100%;"><div class="c-cuerpo1" style="width: 100%; text-align: center;"><input class="c-cuerpo2" style="width: 100%; text-align: center;" list="products" name="producto" id="product"><datalist id="products">@foreach($buscador as $c)<option value="{{$c -> descripcion_despacho}}"></option>@endforeach</datalist></div><div class="c-cuerpo2" style="width: 100%; text-align: center;"><input class="c-cuerpo2" style="width: 100%; text-align: center;" type="number" name="cantidad" id="cantidad"></div><div class="c-arancel" style="width: 100%; text-align: center;"><input class="c-cuerpo2" style="width: 100%; text-align: center;" type="text" name="arancel" id="arancel"></div><div class="c-resultado" style="width: 100%; text-align: center;"><input class="c-cuerpo2" style="width: 100%; text-align: center;" type="text" name="resultado" id="resultado"></div></div>'
        //     })
        // }
